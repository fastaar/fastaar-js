...
class FastaarClient {
     ...
     *
     * @param {{amount: number|string, invoice_id?: string, success_url?: string, cancel_url?: string, metadata?: Object<string, string>}} params
     */
    ...
    /** List payments, newest first. Accepts {status, invoice_id, per_page, page}. */
    ...
    /** Find the most recent payment for one of your invoice IDs, or null. */
